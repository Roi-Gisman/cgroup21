...
namespace WebApplication1.BL
{
    public class Movie
    {
        ...
        public void InsertMovieToCart(int userId, int movieId, DateOnly rentEnd, double totalPrice)
        {
            DBservices dbs = new DBservices();
            int num=dbs.InsertMovieToCart(userId, movieId, rentEnd, totalPrice);
        }
        ...
        public JsonElement getDetailRentMovie(int userId, int movieId)
        {
            DBservices dbs = new DBservices();
